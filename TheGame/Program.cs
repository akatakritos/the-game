...
namespace TheGame
{
    public static class Program
    {
        ...
        //            if (_state.MoveQueue == null || _state.MoveQueue.Mode == ItemMode.Automatic)
        //            {
        //                _state.MoveQueue = _strategy.GetMove(_state, _rules);
        //            }

        //            if (_rules.CanUseItem() && _state.MoveQueue != null)
        //            {
        //                try
        //                {
        //                    var useResult = UseItem(_state.MoveQueue.Item, _state.MoveQueue.Target);
        //                    _state.LastMessages.Insert(0, $"{_state.MoveQueue.Mode}ly used {_state.MoveQueue.Item.Name} on '{_state.MoveQueue.Target}'");
        //                    _state.LastMessages.InsertRange(0, useResult.Messages);
        //                    _state.MoveQueue = null;
        //                }
        ...
        //            if (_state.MoveQueue != null)
        //            {
        //                Console.WriteLine($"{_state.MoveQueue.Mode} Item Scheduled: {_state.MoveQueue.Item.Name} on '{_state.MoveQueue.Target}'");
        //            }
